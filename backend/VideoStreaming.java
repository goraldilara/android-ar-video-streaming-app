...
public class VideoStreaming implements Runnable{
     ...
     */
    VideoStreaming(DatagramSocket sock, ChatServer serverInstance) throws SocketException {
        this.socket = sock;
        this.serverInstance = serverInstance;
        //olmazsa burayı aç c# için
        //messageInstance = new MessageBroadcast(sock, serverInstance);
        messageInstance = new MessageBroadcast(serverInstance);
    }
