...
class MessageSender implements Runnable {
    ...
    public void run() {
        ...
        do {
            try {
                username = window.getHost_name();
                sendMessage("New client connected - welcome!" + username);
                connected = true;
            } catch (Exception e) {
    ...
    public void run() {
        while (true) {
            try {
                ...
                //image capturing
                if(window.getMessage().equals("Screenshot has been captured!!")){
                    imageName = window.getImageName();
